...
const ROUTER_CONFIG = {
    ...
    minerPriority: {
        ...
        visExhibitorMiner: 2,
        mcexpocomfortMiner: 2,
        reedExpoMiner: 2,
        reedExpoMailtoMiner: 2,
        labelValueMiner: 2,
        flipbookMiner: 2,
        spaNetworkMiner: 3,
    ...
    fallbackChains: {
        ...
        memberTableMiner: ['playwrightTableMiner', 'aiMiner'],
        messeFrankfurtMiner: ['playwrightTableMiner', 'aiMiner'],
        visExhibitorMiner: ['spaNetworkMiner', 'playwrightTableMiner'],
        mcexpocomfortMiner: ['playwrightTableMiner', 'aiMiner'],
        reedExpoMiner: ['playwrightTableMiner', 'aiMiner'],
        reedExpoMailtoMiner: ['reedExpoMiner', 'playwrightTableMiner'],
        labelValueMiner: ['playwrightTableMiner', 'aiMiner'],
        flipbookMiner: ['documentMiner', 'playwrightTableMiner'],
